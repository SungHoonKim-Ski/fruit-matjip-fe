  ...
  try {
    ...
    return {
      orders: raw.map((o: any) => ({
        ...
        recipientName: String(o.receiver_name ?? o.receiverName ?? o.recipient_name ?? o.recipientName ?? ''),
        itemSummary: String(o.product_summary ?? o.productSummary ?? o.item_summary ?? o.itemSummary ?? ''),
...
export const getAdminCourierOrder = async (id: number): Promise<AdminCourierOrderDetailResponse> => {
  ...
  try {
    ...
    return {
      ...
      isRemoteArea: Boolean(d.is_island ?? d.isIsland ?? d.is_remote_area ?? d.isRemoteArea ?? false),
      courierCompany: d.courier_company ?? d.courierCompany ?? null,
